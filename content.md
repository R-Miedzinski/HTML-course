...
- Hero section -> header and photo next to each other
- Featured in -> list of companies
- How it works -> Z-pattern
- Sample meals, Diets -> product cards and list of diets

- Testimonials, Photo galery -> list of testimonials, and phooto gallery, F-like pattern
- Pricing, Features -> pricing cards, features cards
